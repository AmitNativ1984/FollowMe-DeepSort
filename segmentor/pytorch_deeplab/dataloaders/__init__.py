...
def make_data_loader(args, **kwargs):
    ...
    elif args.dataset == 'bbox':
        train_set = arbel.ArbelSegmentation(args, root='/home/iariav/Deep/Pytorch/bbox/', split='trainval')
        val_set = arbel.ArbelSegmentation(args, root='/home/iariav/Deep/Pytorch/bbox/', split='val')
        num_class = train_set.NUM_CLASSES
        train_loader = DataLoader(train_set, batch_size=args.batch_size, shuffle=True, drop_last=True, **kwargs)
        val_loader = DataLoader(val_set, batch_size=args.test_batch_size, shuffle=False, drop_last=True,  **kwargs)
        test_loader = None
