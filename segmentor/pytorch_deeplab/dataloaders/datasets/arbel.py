...
class ArbelSegmentation(data.Dataset):
    ...
    def transform_tr(self, sample):
        ...
        color_transforms = [transforms.RandomApply([transforms.ColorJitter(brightness=0.05)]), # brightness
                            transforms.RandomApply([transforms.ColorJitter(contrast=0.05)]), # contrast
                            transforms.RandomApply([transforms.ColorJitter(saturation=0.05)]), # saturation
                            transforms.RandomApply([transforms.ColorJitter(hue=0.03)])] # hue
